...
// FIXME Taobao distribution does not have a
//    case BINARY:
//      return new GenericUDAFBinaryStatsEvaluator();
  ...
  public static class GenericUDAFLongStatsEvaluator extends GenericUDAFEvaluator {
    ...
    private WritableDoubleObjectInspector sumFieldOI;
    ...
    public ObjectInspector init(Mode m, ObjectInspector[] parameters) throws HiveException {
      ...
      if (m == Mode.PARTIAL1 || m == Mode.COMPLETE) {
        ...
        sumFieldOI = (WritableDoubleObjectInspector) sumField.getFieldObjectInspector();
      ...
      if (m == Mode.PARTIAL1 || m == Mode.PARTIAL2) {
        ...
        partialResult[7] = new LongWritable(0);
        ...
        result[5] = new DoubleWritable(0);
        result[6] = new DoubleWritable(0);
    ...
    public static class LongStatsAgg implements AggregationBuffer {
      ...
      public double sum;  // TODO Should I use BigInteger here? lost performance and increase precision
      public long count;
    };
    ...
    public void iterate(AggregationBuffer agg, Object[] parameters) throws HiveException {
      ...
      if (p == null) {
        ...
        try {
          ...
          myagg.sum += v;  // TODO Should I use BigInteger here?
    ...
    public Object terminatePartial(AggregationBuffer agg) throws HiveException {
      ...
      if (myagg.min != null) {
    	  partialResult[1] = new LongWritable(myagg.min); 
      }
      if (myagg.max != null) {
    	  partialResult[2] = new LongWritable(myagg.max); 
      }
   
      ((LongWritable) partialResult[3]).set(myagg.countNulls);
      ((Text) partialResult[4]).set(t);
      ((IntWritable) partialResult[5]).set(myagg.numDV.getnumBitVectors());
      ((DoubleWritable) partialResult[6]).set(myagg.sum);
      ((LongWritable) partialResult[7]).set(myagg.count);
    ...
    public void merge(AggregationBuffer agg, Object partial) throws HiveException {
      if (partial != null) {
        ...
        if (partialValue != null && 
        		(myagg.min == null || myagg.min > minFieldOI.get(partialValue))) {
        ...
        if (partialValue != null && 
        		(myagg.max == null || myagg.max < maxFieldOI.get(partialValue))) {
        ...
        partialValue = soi.getStructFieldData(partial, sumField);
        myagg.sum += sumFieldOI.get(partialValue);
    ...
    public Object terminate(AggregationBuffer agg) throws HiveException {
      ...
      ((Text) result[0]).set(myagg.columnType);
      if (myagg.min != null) {
    	  result[1] = new LongWritable(myagg.min);
      }
      if (myagg.max != null) {
    	  result[2] = new LongWritable(myagg.max);
      }
      ((LongWritable) result[3]).set(myagg.countNulls);
      ((LongWritable) result[4]).set(numDV);
      ((DoubleWritable) result[5]).set(myagg.sum);
      ((DoubleWritable) result[6]).set(myagg.sum / myagg.count);
   ...
   *
   */
// FIXME Taobao distribution has NO BINARY objects
